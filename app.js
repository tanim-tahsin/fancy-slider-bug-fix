...
const showImages = (images) => {
  ...
  images.forEach(image => {
    ...
    div.className = 'id="img-counter"  col-lg-3 col-md-4 col-xs-6 img-item mb-2';
...
const selectItem = (event, img) => {
  ...
  let count = document.getElementById("count-img").innerText;
  let countNumber = parseInt(count)
  let item = sliders.indexOf(img);
  if (item === -1) {
    sliders.push(img);
    let totalCount = countNumber + 1;
    document.getElementById("count-img").innerText = totalCount;
  } else  {
